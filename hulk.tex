...
The library is made of 91 files for a total 124 thousands lines od code.
...
a few were merged, others are put on hold waiting for the library begin ported
to Hierarchy Builder.

Hierarchy Builder is a set of commands implemented in Coq-Elpi which take
care of automatically synthesizing all the error boilerplate required for
packed classed to work. ...
...
Hierarcy Builder. The whole library finally compiled on April 20.

The porting consisted in declaring all the interfaces and their instances
using the new command, without changing proofs in any substantial way.
